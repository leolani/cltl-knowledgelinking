...
class EntitySearch(BasicBrain):
    ...
    def _get_most_popular_by_label(self, ne_text):
        query = read_query('/Users/jaapkruijt/Documents/GitHub/cltl-knowledgelinking/src/cltl/entity_linking/popularity') % ne_text
    ...
    def _get_most_recent_by_label(self, ne_text):
        query = read_query('/Users/jaapkruijt/Documents/GitHub/cltl-knowledgelinking/src/cltl/entity_linking/recency_last_mention') % ne_text
        response = self._submit_query(query)
        if response:
